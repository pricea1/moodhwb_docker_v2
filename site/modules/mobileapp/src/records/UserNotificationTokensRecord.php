...
namespace \moodhwb\mobileapp\records;
 ...
 * @since     1
 */
class UserNotificationTokensRecord extends ActiveRecord
{
...
//       return 'moduleactions_moduleview';
       return '{{%mobileapp_usernotificationtokens}}';
    }
}
