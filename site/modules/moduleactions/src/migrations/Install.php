...
namespace \modules\moduleactions\migrations;
...
/**
 * moduleactions Install Migration
 *
...
class Install extends Migration
{
    ...
    // moduleactions_moduleactionsrecord table
        $tableSchema = Craft::$app->db->schema->getTableSchema('{{%moduleactions_moduleactionsrecord}}');
        if ($tableSchema === null) {
            $tablesCreated = true;
            $this->createTable(
                '{{%moduleactions_moduleactionsrecord}}',
                [
                    'id' => $this->primaryKey(),
    ...
    // moduleactions_moduleactionsrecord table
        $this->addForeignKey(
            $this->db->getForeignKeyName('{{%moduleactions_moduleactionsrecord}}', 'siteId'),
            '{{%moduleactions_moduleactionsrecord}}',
            'siteId',
            '{{%sites}}',
            'id',
    ...
    {
    // moduleactions_moduleactionsrecord table
        $this->dropTableIfExists('{{%moduleactions_moduleactionsrecord}}');
    }
}
